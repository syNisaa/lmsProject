    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card">
                ...
                @if($rs->foto)
                <img src="{{ asset('backend/assets/img/peserta/' . $rs->foto) }}" alt="{{ $rs->nama }}" class="rounded-circle">
                @else
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Nomer Hp</div>
                                <div class="col-lg-9 col-md-8">{{ $rs->no_hp}}</div>
                            </div>
                           

                        </div>
                        <a href="{{ url('/peserta') }}" class="btn btn-primary">Go Back</a>
